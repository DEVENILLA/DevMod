...
public class Damaged1DevScreen extends HandledScreen<Damaged1DevScreenHandler>
{
    ...
    protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        RenderSystem.setShaderTexture(0, new Identifier(DevMod.MOD_ID, "textures/gui/container/dev_inventory_dmg_1.png"));
