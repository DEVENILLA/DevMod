...
public class AncientInfectorNavigation extends MobNavigation {
    @Nullable
    private BlockPos targetPos;
    public final AncientInfector infector;

    public AncientInfectorNavigation(MobEntity mobEntity, World world) {
        super(mobEntity, world);
        infector = (AncientInfector)mobEntity;
    }
